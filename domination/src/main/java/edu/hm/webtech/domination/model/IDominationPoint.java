...
public interface IDominationPoint extends ILocationObject {
	 ...
	 * 
	 * @param captureTeam
	 *            {@link ITeam} currently capturing the domination point.
	 */
	 ...
	 * 
	 * @param ownerTeam
	 *            {@link ITeam} currently owning the domination point.
	 */
	 ...
	 *            value which will be added to the capture progress.
	 */
