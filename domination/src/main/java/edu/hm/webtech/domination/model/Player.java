...
public class Player extends LocationObject implements IPlayer, ScorePublisher {
    ...
    private String name;
    /**
     * Das Team dem der Spieler angehört. null falls der Spieler keinem Spiel angehört.
     */
    private ITeam team;
    /**
     ...
     */
    public Player(final double longitude, final double latitude, final String name, final ITeam team, final int score) {
     ...
     * @param team      Das Team des Spielers.
     */
    public Player(final double longitude, final double latitude, final String name, final ITeam team) {
     ...
     * @param name      Der Name des Spielers.
     */
    public Player(final double longitude, final double latitude, final String name) {
